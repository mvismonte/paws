...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_behavior', (
            ...
            ('reaction', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
        ...
        # Deleting field 'AnimalObservation.description'
        db.delete_column('main_animalobservation', 'description')


        # Renaming column for 'AnimalObservation.behavior' to match new field type.
        db.rename_column('main_animalobservation', 'behavior', 'behavior_id')
        # Changing field 'AnimalObservation.behavior'
        db.alter_column('main_animalobservation', 'behavior_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Behavior'], null=True))
        # Adding index on 'AnimalObservation', fields ['behavior']
        db.create_index('main_animalobservation', ['behavior_id'])

        # Removing M2M table for field animals on 'Staff'
        db.delete_table('main_staff_animals')

    def backwards(self, orm):
        # Removing index on 'AnimalObservation', fields ['behavior']
        db.delete_index('main_animalobservation', ['behavior_id'])

        # Deleting model 'Behavior'
        db.delete_table('main_behavior')

        # Adding field 'AnimalObservation.description'
        db.add_column('main_animalobservation', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Renaming column for 'AnimalObservation.behavior' to match new field type.
        db.rename_column('main_animalobservation', 'behavior_id', 'behavior')
        # Changing field 'AnimalObservation.behavior'
        db.alter_column('main_animalobservation', 'behavior', self.gf('django.db.models.fields.SmallIntegerField')(null=True))
    ...
    models = {
        ...
        'main.behavior': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'reaction': ('django.db.models.fields.SmallIntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        'main.category': {
