...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Observation.date_finished'
        db.alter_column('main_observation', 'date_finished', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Observation.date_finished'
        db.alter_column('main_observation', 'date_finished', self.gf('django.db.models.fields.DateTimeField')(default=''))

        # Changing field 'AnimalObservation.behavior'
        db.alter_column('main_animalobservation', 'behavior', self.gf('django.db.models.fields.SmallIntegerField')(default=0))
    models = {
        'auth.group': {
